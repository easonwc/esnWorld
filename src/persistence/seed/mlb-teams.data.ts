...
export const MLB_TEAM_SEED_DATA = [
  ...
  { name: "Washington Nationals", abbreviation: "WSH", conferenceAbbreviation: "NL", divisionAbbreviation: "NL_EAST", locationName: "Washington, D.C.", locationRegion: "", countryName: "United States", stadiumName: "Nationals Park", latitude: 38.873, longitude: -77.0074, isIndoor: false },
