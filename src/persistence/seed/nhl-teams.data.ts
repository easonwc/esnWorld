...
export const NHL_TEAM_SEED_DATA = [
  ...
  { name: "Washington Capitals", abbreviation: "WSH", conferenceAbbreviation: "EAST", divisionAbbreviation: "EAST_MET", locationName: "Washington, D.C.", locationRegion: "District of Columbia", countryName: "United States", stadiumName: "Capital One Arena", latitude: 38.8981, longitude: -77.0209, isIndoor: true },
