...
export const WNBA_TEAM_SEED_DATA = [
  ...
  { name: "Chicago Sky", abbreviation: "CHI", conferenceAbbreviation: "EAST", divisionAbbreviation: "WNBA_EAST", locationName: "Chicago", locationRegion: "", countryName: "United States", stadiumName: "Wintrust Arena", latitude: 41.8506, longitude: -87.6168, isIndoor: true },
  ...
  { name: "Washington Mystics", abbreviation: "WAS", conferenceAbbreviation: "EAST", divisionAbbreviation: "WNBA_EAST", locationName: "Washington, D.C.", locationRegion: "", countryName: "United States", stadiumName: "Entertainment and Sports Arena", latitude: 38.8683, longitude: -76.9939, isIndoor: true },
  ...
  { name: "Golden State Valkyries", abbreviation: "GSV", conferenceAbbreviation: "WEST", divisionAbbreviation: "WNBA_WEST", locationName: "San Francisco", locationRegion: "", countryName: "United States", stadiumName: "Chase Center", latitude: 37.768, longitude: -122.3877, isIndoor: true },
  { name: "Las Vegas Aces", abbreviation: "LV", conferenceAbbreviation: "WEST", divisionAbbreviation: "WNBA_WEST", locationName: "Las Vegas", locationRegion: "", countryName: "United States", stadiumName: "Michelob ULTRA Arena", latitude: 36.0908, longitude: -115.1761, isIndoor: true },
  { name: "Los Angeles Sparks", abbreviation: "LA", conferenceAbbreviation: "WEST", divisionAbbreviation: "WNBA_WEST", locationName: "Los Angeles", locationRegion: "", countryName: "United States", stadiumName: "Crypto.com Arena", latitude: 34.043, longitude: -118.2673, isIndoor: true },
  ...
  { name: "Phoenix Mercury", abbreviation: "PHX", conferenceAbbreviation: "WEST", divisionAbbreviation: "WNBA_WEST", locationName: "Phoenix", locationRegion: "", countryName: "United States", stadiumName: "Footprint Center", latitude: 33.4457, longitude: -112.0712, isIndoor: true },
  { name: "Seattle Storm", abbreviation: "SEA", conferenceAbbreviation: "WEST", divisionAbbreviation: "WNBA_WEST", locationName: "Seattle", locationRegion: "", countryName: "United States", stadiumName: "Climate Pledge Arena", latitude: 47.6221, longitude: -122.354, isIndoor: true },
] as const;
